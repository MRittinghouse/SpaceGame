...
EMBLEM_PROMPTS: dict[str, str] = {
    "commerce_guild": (
        "A faction emblem: a stylized golden balance scale "
        + _GREEN_BG
    ...
    "miners_union": (
        "A faction emblem: two crossed mining pickaxes over a gear "
        + _GREEN_BG
    ...
    "science_collective": (
        "A faction emblem: a stylized atom with orbiting electrons "
        + _GREEN_BG
    ...
    "frontier_alliance": (
        "A faction emblem: a compass rose star "
        + _GREEN_BG
    ...
    "crimson_reach": (
        "A faction emblem: a cracked skull with toxic green eyes "
        + _GREEN_BG
...
PLAYER_SHIP_PROMPTS: dict[str, str] = {
    "shuttle": (
        "A top-down pixel art spaceship: small civilian shuttle "
        + _GREEN_BG
    ...
    "light_freighter": (
        "A top-down pixel art spaceship: light cargo freighter "
        + _GREEN_BG
    ...
    "medium_freighter": (
        "A top-down pixel art spaceship: medium cargo freighter "
        + _GREEN_BG
    ...
    "fast_courier": (
        "A top-down pixel art spaceship: fast courier vessel "
        + _GREEN_BG
    ...
    "armed_trader": (
        "A top-down pixel art spaceship: armed merchant vessel "
        + _GREEN_BG
    ...
    "scout_vessel": (
        "A top-down pixel art spaceship: long-range scout ship "
        + _GREEN_BG
    ...
    "bulk_hauler": (
        "A top-down pixel art spaceship: massive bulk cargo hauler "
        + _GREEN_BG
    ...
    "clipper": (
        "A top-down pixel art spaceship: fast smuggling clipper "
        + _GREEN_BG
    ...
    "luxury_yacht": (
        "A top-down pixel art spaceship: luxury executive yacht "
        + _GREEN_BG
...
ENEMY_SHIP_PROMPTS: dict[str, str] = {
    "pirate_light": (
        "A top-down pixel art spaceship: small pirate raider "
        + _GREEN_BG
    ...
    "pirate_medium": (
        "A top-down pixel art spaceship: pirate attack vessel "
        + _GREEN_BG
    ...
    "pirate_heavy": (
        "A top-down pixel art spaceship: heavy pirate warship "
        + _GREEN_BG
    ...
    "patrol_craft": (
        "A top-down pixel art spaceship: military patrol vessel "
        + _GREEN_BG
    ...
    "enforcer": (
        "A top-down pixel art spaceship: heavy enforcement cruiser "
        + _GREEN_BG
    ...
    "industrial_combat": (
        "A top-down pixel art spaceship: converted mining vessel "
        + _GREEN_BG
    ...
    "science_vessel": (
        "A top-down pixel art spaceship: advanced research ship "
        + _GREEN_BG
    ...
    "frontier_kitbash": (
        "A top-down pixel art spaceship: salvage-built fighter "
        + _GREEN_BG
    ...
    "bounty_hunter": (
        "A top-down pixel art spaceship: bounty hunter interceptor "
        + _GREEN_BG
    ...
    "reach_rustrunner": (
        "A top-down pixel art spaceship: scrapyard racer "
        + _GREEN_BG
    ...
    "guild_cruiser": (
        "A top-down pixel art spaceship: heavy corporate battlecruiser "
        + _GREEN_BG
    ...
    "union_barge": (
        "A top-down pixel art spaceship: heavy industrial barge "
        + _GREEN_BG
    ...
    "union_skiff": (
        "A top-down pixel art spaceship: small mining patrol boat "
        + _GREEN_BG
    ...
    "science_frigate": (
        "A top-down pixel art spaceship: advanced science warship "
        + _GREEN_BG
    ...
    "science_drone": (
        "A top-down pixel art spaceship: small autonomous drone "
        + _GREEN_BG
    ...
    "frontier_gunboat": (
        "A top-down pixel art spaceship: heavy frontier gunboat "
        + _GREEN_BG
    ...
    "frontier_scout": (
        "A top-down pixel art spaceship: light frontier scout "
        + _GREEN_BG
    ...
    "reach_wrecker": (
        "A top-down pixel art spaceship: medium scrapyard destroyer "
        + _GREEN_BG
    ...
    "reach_hulk": (
        "A top-down pixel art spaceship: massive scrapyard dreadnought "
        + _GREEN_BG
    ...
    "bounty_cruiser": (
        "A top-down pixel art spaceship: heavy bounty hunter cruiser "
        + _GREEN_BG
    ...
    "smuggler_runner": (
        "A top-down pixel art spaceship: fast smuggler blockade runner "
        + _GREEN_BG
    ...
    "ledger_warship": (
        "A top-down pixel art spaceship: military-grade pirate warship "
        + _GREEN_BG
    ...
    "armored_transport": (
        "A top-down pixel art spaceship: heavily armored cargo hauler "
        + _GREEN_BG
    ...
    "cryo_interceptor": (
        "A top-down pixel art spaceship: fast cryo-weapon interceptor "
        + _GREEN_BG
    ...
    "ghost_raider": (
        "A top-down pixel art spaceship: stealth raider "
        + _GREEN_BG
    ...
    "guild_arbiter": (
        "A top-down pixel art spaceship: trade authority enforcement vessel "
        + _GREEN_BG
    ...
    "ion_striker": (
        "A top-down pixel art spaceship: fast ion-weapon attack craft "
        + _GREEN_BG
    ...
    "plasma_bomber": (
        "A top-down pixel art spaceship: heavy plasma bomber "
        + _GREEN_BG
    ...
    "rogue_ai_vessel": (
        "A top-down pixel art spaceship: autonomous AI ship "
        + _GREEN_BG
    ...
    "shield_drone": (
        "A top-down pixel art spaceship: small shield support drone "
        + _GREEN_BG
    ...
    "support_frigate": (
        "A top-down pixel art spaceship: medium support frigate "
        + _GREEN_BG
    ...
    "corsair_king": (
        "A top-down pixel art spaceship: MASSIVE pirate flagship boss "
        + _GREEN_BG
    ...
    "iron_maw": (
        "A top-down pixel art spaceship: MASSIVE industrial fortress-ship boss "
        + _GREEN_BG
    ...
    "ledger_phantom": (
        "A top-down pixel art spaceship: ethereal ghost ship boss "
        + _GREEN_BG
    ...
    "the_collector": (
        "A top-down pixel art spaceship: bizarre trophy hunter boss ship "
        + _GREEN_BG
    ...
    "void_leviathan": (
        "A top-down pixel art spaceship: organic cosmic horror boss "
        + _GREEN_BG
...
UPGRADE_PROMPTS: dict[str, str] = {
    ...
    "salvaged_pulse_emitter": (
        "A small weapon icon: a crude pulse gun "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    "mining_laser_retrofit": (
        "A small weapon icon: a converted mining laser "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    "laser_cannon": (
        "A small weapon icon: a laser cannon barrel "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    "dual_laser": (
        "A small weapon icon: twin laser barrels "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    "missile_launcher": (
        "A small weapon icon: a missile launcher pod "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    "ion_disruptor": (
        "A small weapon icon: an ion disruption device "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    "plasma_torpedo": (
        "A small weapon icon: a plasma torpedo tube "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    # Defense
    "basic_shield_gen": (
        "A small defense icon: a shield generator device "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    "armor_plating": (
        "A small defense icon: a reinforced armor plate "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    "point_defense": (
        "A small defense icon: an automated turret "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    "emergency_repair": (
        "A small utility icon: a repair kit "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    "advanced_shield": (
        "A small defense icon: an advanced shield array "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    # Utility
    "cargo_bay_ext": (
        "A small utility icon: a cargo bay extension "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    "fuel_tank_upgrade": (
        "A small utility icon: a fuel tank "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    "efficient_engines": (
        "A small utility icon: an engine thruster "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    "emergency_thrusters": (
        "A small utility icon: emergency booster rockets "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    "mining_drill_mk2": (
        "A small utility icon: an upgraded mining drill "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    "advanced_scanner": (
        "A small utility icon: a scanning dish "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    # Smuggling
    "hidden_compartment": (
        "A small utility icon: a secret hidden panel "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    "signal_jammer": (
        "A small utility icon: an electronic jammer device "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    "false_transponder": (
        "A small utility icon: a forged ID transponder chip "
        + _GREEN_BG
        + _FLAT_VIEW
...
MINING_ROCK_PROMPTS: dict[str, str] = {
    ...
    "rock_raw_ore_v1": (
        "A space rock: common asteroid chunk "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    "rock_raw_ore_v2": (
        "A space rock: common asteroid fragment "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    "rock_raw_ore_v3": (
        "A space rock: small common asteroid "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    "rock_iron_ore_v1": (
        "A space rock: iron-rich asteroid "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    "rock_iron_ore_v3": (
        "A space rock: iron-bearing asteroid "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    "rock_crystal_ore_v1": (
        "A space rock: crystal-encrusted asteroid "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    "rock_crystal_ore_v2": (
        "A space rock: crystal-veined asteroid "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    "rock_crystal_ore_v3": (
        "A space rock: crystal cluster asteroid "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    "rock_rare_ore_v1": (
        "A space rock: rare gem-bearing asteroid "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    "rock_rare_ore_v2": (
        "A space rock: rare mineral asteroid "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    "rock_rare_ore_v3": (
        "A space rock: rare precious ore "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    "rock_common_metals_v1": (
        "A space rock: dense metallic asteroid "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    "rock_common_metals_v2": (
        "A space rock: dense ore deposit "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    "rock_common_metals_v3": (
        "A space rock: dense metallic chunk "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    "rock_unstable_v1": (
        "A space rock: volatile unstable asteroid "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    "rock_unstable_v2": (
        "A space rock: unstable explosive asteroid "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    "rock_unstable_v3": (
        "A space rock: volatile ore chunk "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    "rock_monolith_v1": (
        "A space rock: alien monolith artifact "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    "rock_vent_v1": (
        "A space rock: pressure vent asteroid "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    "rock_vent_v2": (
        "A space rock: steaming vent rock "
        + _GREEN_BG
        + _FLAT_VIEW
...
SALVAGE_CELL_PROMPTS: dict[str, str] = {
    ...
    "salvage_cell_hidden": (
        "A spaceship hull panel: sealed, unexplored "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    "salvage_cell_scanned": (
        "A spaceship hull panel: scanned, contents detected "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    "salvage_cell_item": (
        "A spaceship hull panel: opened, item visible inside "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    "salvage_cell_extracted": (
        "A spaceship hull panel: emptied after extraction "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    "quality_frame_poor": (
        "A small square frame border: common/poor quality indicator "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    "quality_frame_normal": (
        "A small square frame border: normal quality indicator "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    "quality_frame_good": (
        "A small square frame border: good quality indicator "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    "quality_frame_excellent": (
        "A small square frame border: excellent/rare quality indicator "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    "icon_scan_mode": (
        "A small utility icon: scanner/radar pulse "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    "icon_extract_mode": (
        "A small utility icon: extraction tool/claw "
        + _GREEN_BG
        + _FLAT_VIEW
...
GROUND_TILE_PROMPTS: dict[str, str] = {
    "floor": (
        "A top-down tile: metal floor panel "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    "wall": (
        "A top-down tile: solid wall section "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    "door_closed": (
        "A top-down tile: a closed sliding door "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    "door_open": (
        "A top-down tile: an open doorway "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    "exit": (
        "A top-down tile: an exit marker on floor "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    "entrance": (
        "A top-down tile: an entry point marker "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    "noisy_floor": (
        "A top-down tile: loose metal floor grating "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    "terminal": (
        "A top-down tile: data terminal on floor "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    "hazard": (
        "A top-down tile: environmental hazard floor "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    "vent": (
        "A top-down tile: steam vent grate "
        + _GREEN_BG
        + _FLAT_VIEW
...
GROUND_PLAYER_PROMPTS: dict[str, str] = {
    "player": (
        "A top-down pixel art character: space trader pilot "
        + _GREEN_BG
        + _FLAT_VIEW
...
GROUND_ENEMY_PROMPTS: dict[str, str] = {
    "guild_security": (
        "A top-down pixel art character: corporate security guard "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    "union_worker": (
        "A top-down pixel art character: mining worker "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    "pirate_thug": (
        "A top-down pixel art character: space pirate thug "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    "collective_drone": (
        "A top-down pixel art robot: hovering science drone "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    "alliance_scrapper": (
        "A top-down pixel art character: frontier scrapper "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    "elite_guard": (
        "A top-down pixel art character: elite heavy guard "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    "station_sentry": (
        "A top-down pixel art robot: automated turret sentry "
        + _GREEN_BG
        + _FLAT_VIEW
    ...
    "crimson_enforcer": (
        "A top-down pixel art character: sinister enforcer "
        + _GREEN_BG
        + _FLAT_VIEW
...
SKILL_ICON_PROMPTS: dict[str, str] = {
    # Trading Mastery
    "negotiator": (
        "A small icon: two people shaking hands "
        + _GREEN_BG
        + _FLAT_VIEW
        + "Handshake deal symbol. Gold and blue colors. "
        + _ICON_STYLE
    ),
    "market_eye": (
        "A small icon: an eye with a gold coin reflection "
        + _GREEN_BG
        + _FLAT_VIEW
        + "All-seeing market eye. Blue eye with gold glint. "
        + _ICON_STYLE
    ),
    "bulk_trader": (
        "A small icon: stacked cargo crates "
        + _GREEN_BG
        + _FLAT_VIEW
        + "Multiple boxes stacked together. Brown crates, large quantity. "
        + _ICON_STYLE
    ),
    "trade_network": (
        "A small icon: connected nodes in a network "
        + _GREEN_BG
        + _FLAT_VIEW
        + "Three dots connected by lines forming a trade network. Blue lines. "
        + _ICON_STYLE
    ),
    "market_insider": (
        "A small icon: a scroll with a gold seal "
        + _GREEN_BG
        + _FLAT_VIEW
        + "Secret market intelligence document. Parchment with gold wax seal. "
        + _ICON_STYLE
    ),
    # Resource Gathering
    "efficient_drills": (
        "A small icon: a mining drill bit "
        + _GREEN_BG
        + _FLAT_VIEW
        + "Sharp spinning drill head. Steel gray with orange sparks. "
        + _ICON_STYLE
    ),
    "keen_scanner": (
        "A small icon: a radar scanner dish "
        + _GREEN_BG
        + _FLAT_VIEW
        + "Small radar dish emitting scan waves. Blue scan lines. "
        + _ICON_STYLE
    ),
    "rich_veins": (
        "A small icon: glowing crystal ore vein "
        + _GREEN_BG
        + _FLAT_VIEW
        + "Cracked rock with bright crystal ore visible inside. Purple crystal. "
        + _ICON_STYLE
    ),
    "master_extractor": (
        "A small icon: a pickaxe with a gem "
        + _GREEN_BG
        + _FLAT_VIEW
        + "Pickaxe striking a gemstone. Steel pickaxe, bright gem. "
        + _ICON_STYLE
    ),
    "refining_knowledge": (
        "A small icon: a crucible with molten metal "
        + _GREEN_BG
        + _FLAT_VIEW
        + "Small smelting crucible with orange molten glow. "
        + _ICON_STYLE
    ),
    "efficient_refining": (
        "A small icon: a gear with an up arrow "
        + _GREEN_BG
        + _FLAT_VIEW
        + "Mechanical gear with efficiency arrow pointing up. Steel and green. "
        + _ICON_STYLE
    ),
    "yield_mastery": (
        "A small icon: overflowing treasure chest "
        + _GREEN_BG
        + _FLAT_VIEW
        + "Small chest overflowing with gems and ore. Gold and jewel colors. "
        + _ICON_STYLE
    ),
    # Mining Mastery
    "click_power": (
        "A small icon: a fist striking downward "
        + _GREEN_BG
        + _FLAT_VIEW
        + "Powerful fist punch impact. Orange impact sparks. "
        + _ICON_STYLE
    ),
    "passive_drill": (
        "A small icon: an automated drill machine "
        + _GREEN_BG
        + _FLAT_VIEW
        + "Self-operating drill with clockwork gears. Steel and bronze. "
        + _ICON_STYLE
    ),
    "deep_scan": (
        "A small icon: sonar pulse rings "
        + _GREEN_BG
        + _FLAT_VIEW
        + "Concentric scan rings expanding outward. Blue sonar waves. "
        + _ICON_STYLE
    ),
    "drone_bay_1": (
        "A small icon: a single small drone "
        + _GREEN_BG
        + _FLAT_VIEW
        + "One small mining drone with blue lights. Compact robot. "
        + _ICON_STYLE
    ),
    "drone_bay_2": (
        "A small icon: two small drones "
        + _GREEN_BG
        + _FLAT_VIEW
        + "Two mining drones flying together. Blue lights, paired. "
        + _ICON_STYLE
    ),
    "drone_bay_3": (
        "A small icon: three small drones in formation "
        + _GREEN_BG
        + _FLAT_VIEW
        + "Three mining drones in triangle formation. Blue lights. "
        + _ICON_STYLE
    ),
    "drone_efficiency": (
        "A small icon: a drone with a wrench "
        + _GREEN_BG
        + _FLAT_VIEW
        + "Upgraded drone with efficiency wrench symbol. Blue and steel. "
        + _ICON_STYLE
    ),
    "ore_targeting": (
        "A small icon: crosshair on a rock "
        + _GREEN_BG
        + _FLAT_VIEW
        + "Targeting reticle focused on ore deposit. Red crosshair. "
        + _ICON_STYLE
    ),
    "chain_reaction": (
        "A small icon: explosion with chain links "
        + _GREEN_BG
        + _FLAT_VIEW
        + "Small explosion with radiating blast waves. Orange and yellow. "
        + _ICON_STYLE
    ),
    # Leadership & Operations
    "crew_manager": (
        "A small icon: a clipboard with crew roster "
        + _GREEN_BG
        + _FLAT_VIEW
        + "Clipboard with list of names. Blue and white, organized. "
        + _ICON_STYLE
    ),
    "diplomatic_relations": (
        "A small icon: a dove with an olive branch "
        + _GREEN_BG
        + _FLAT_VIEW
        + "Peace dove carrying branch. White bird, green branch. "
        + _ICON_STYLE
    ),
    "inspiring_leader": (
        "A small icon: a raised banner flag "
        + _GREEN_BG
        + _FLAT_VIEW
        + "Waving command banner on flagpole. Blue flag, gold trim. "
        + _ICON_STYLE
    ),
    "tariff_negotiation": (
        "A small icon: a balance scale with coins "
        + _GREEN_BG
        + _FLAT_VIEW
        + "Trading balance scale with gold coins. Fair trade symbol. "
        + _ICON_STYLE
    ),
    "crew_mentor": (
        "A small icon: a book with a star "
        + _GREEN_BG
        + _FLAT_VIEW
        + "Open book with glowing star above it. Knowledge and guidance. "
        + _ICON_STYLE
    ),
    # Social Arts
    "silver_tongue": (
        "A small icon: a silver speech bubble "
        + _GREEN_BG
        + _FLAT_VIEW
        + "Shiny silver speech bubble with sparkle. Persuasive words. "
        + _ICON_STYLE
    ),
    "commanding_presence": (
        "A small icon: a crown or command star "
        + _GREEN_BG
        + _FLAT_VIEW
        + "Gold command star radiating authority aura. Leadership symbol. "
        + _ICON_STYLE
    ),
    "keen_insight": (
        "A small icon: a glowing third eye "
        + _GREEN_BG
        + _FLAT_VIEW
        + "Mystical eye glowing with blue perception light. Wisdom symbol. "
        + _ICON_STYLE
    ),
    # Ground Combat
    "scrapper": (
        "A small icon: crossed fists "
        + _GREEN_BG
        + _FLAT_VIEW
        + "Two fists crossed in combat stance. Strong fighter symbol. "
        + _ICON_STYLE
    ),
    "tough_hide": (
        "A small icon: a shield with armor plates "
        + _GREEN_BG
        + _FLAT_VIEW
        + "Heavy metal shield with rivets. Steel gray, tough defense. "
        + _ICON_STYLE
    ),
    "quick_reflexes": (
        "A small icon: a lightning bolt "
        + _GREEN_BG
        + _FLAT_VIEW
        + "Fast yellow lightning bolt. Speed and agility symbol. "
        + _ICON_STYLE
    ),
    "intimidating_presence": (
        "A small icon: a skull with red eyes "
        + _GREEN_BG
        + _FLAT_VIEW
        + "Menacing skull with glowing red eyes. Fear and intimidation. "
        + _ICON_STYLE
    ),
    "last_stand": (
        "A small icon: a broken sword standing upright "
        + _GREEN_BG
        + _FLAT_VIEW
        + "Broken blade thrust into ground. Final defiance, never give up. "
        + _ICON_STYLE
    ),
    "veteran": (
        "A small icon: a medal with star "
        + _GREEN_BG
        + _FLAT_VIEW
        + "Military medal of honor with gold star. Battle experience. "
        + _ICON_STYLE
    ),
}
...
HUB_ICON_PROMPTS: dict[str, str] = {
    "market": (
        "A small icon: a market stall or shop "
        + _GREEN_BG
        + _FLAT_VIEW
        + "Trading market stand with goods. Gold coins and crates. "
        + _ICON_STYLE
    ),
    "cantina": (
        "A small icon: a drinking glass or mug "
        + _GREEN_BG
        + _FLAT_VIEW
        + "Space bar drink in a futuristic glass. Blue liquid glowing. "
        + _ICON_STYLE
    ),
    "repair_bay": (
        "A small icon: a wrench and gear "
        + _GREEN_BG
        + _FLAT_VIEW
        + "Repair wrench crossing a mechanical gear. Steel and orange. "
        + _ICON_STYLE
    ),
    "mining": (
        "A small icon: a pickaxe on rock "
        + _GREEN_BG
        + _FLAT_VIEW
        + "Mining pickaxe embedded in asteroid rock. Gray and orange sparks. "
        + _ICON_STYLE
    ),
    "salvaging": (
        "A small icon: a magnet pulling scrap "
        + _GREEN_BG
        + _FLAT_VIEW
        + "Magnetic salvage claw grabbing metal debris. Red magnet, gray scrap. "
        + _ICON_STYLE
    ),
    "refining": (
        "A small icon: a furnace or smelter "
        + _GREEN_BG
        + _FLAT_VIEW
        + "Small refining furnace with molten metal glow. Orange and steel. "
        + _ICON_STYLE
    ),
    "shipyard": (
        "A small icon: a ship hull frame "
        + _GREEN_BG
        + _FLAT_VIEW
        + "Ship under construction, wireframe hull skeleton. Blue and steel. "
        + _ICON_STYLE
    ),
    "unique": (
        "A small icon: a glowing star or diamond "
        + _GREEN_BG
        + _FLAT_VIEW
        + "Special rare glowing diamond or star. Bright gold with sparkle. "
        + _ICON_STYLE
    ),
}
...
def main() -> None:
    ...
    if failed:
        ...
        print(
            f"Re-run with: python tools/generate_sprites.py {args.category} --only {' '.join(failed)}"
        )
