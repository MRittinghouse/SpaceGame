...
VALID_STAT_KEYS = {
    "trades_completed", "credits_earned_lifetime", "credits_spent_lifetime",
    "largest_single_profit", "jumps_traveled", "fuel_consumed",
    "ore_mined", "items_salvaged", "items_refined", "level",
    "systems_discovered", "max_mining_depth", "total_chains_triggered",
    "rare_ores_mined", "salvage_sessions_completed", "corrupted_items_extracted",
    "refining_jobs_completed", "batch_jobs_queued", "unique_recipes_crafted",
    "investments_owned", "s_ranks_earned",
    "ground_missions_completed", "ground_undetected_completions",
    "ground_enemies_defeated", "ground_enemies_talked",
    "ground_tiles_explored", "ground_campaign_missions_completed",
    "goods_smuggled", "max_criminal_heat_reached",
    "inspections_passed_with_contraband",
    # New stat keys from Batch 1
    "combats_won", "combats_fled", "combats_negotiated", "combats_bribed",
    "side_missions_completed", "crew_quests_completed", "encounters_survived",
}
