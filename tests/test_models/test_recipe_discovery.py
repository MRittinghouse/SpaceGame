...
class TestRecipeDiscoveryFields:
    ...
    def test_discoverable_recipe(self) -> None:
        recipe = Recipe(
            id="craft_reinforced_plating",
            name="Forge Reinforced Plating",
            description="test",
            inputs={"alloy_composite": 4},
            outputs={"crafted_reinforced_plating": 1},
    ...
    def test_initialize_default_discoveries(self) -> None:
        ...
        recipes = [
            ...
            Recipe(
                ...
                location_ids=["forgeworks"],
                discoverable=True,
                discovery_prerequisite="smelt_iron",
            ),
        ]
    ...
    def test_mastery_3_discovers_dependent_recipe(self) -> None:
        ...
        recipes = [
            Recipe(
                ...
                name="Forge Alloy",
                description="test",
                inputs={"common_metals": 5},
                outputs={"alloy_composite": 2},
