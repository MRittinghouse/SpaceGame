...
class TestGroundInteractableCommodities:
    ...
    def test_with_commodities(self) -> None:
        obj = GroundInteractable(
            x=0, y=0, interact_type="loot_container",
    ...
    def test_loot_returns_commodities(self) -> None:
        obj = GroundInteractable(
            x=1, y=2, interact_type="loot_container",
            loot_credits=50,
    ...
    def test_serialization_round_trip(self) -> None:
        obj = GroundInteractable(
            x=3, y=4, interact_type="loot_container",
            loot_credits=75,
...
def _make_mission_config() -> "GroundMissionConfig":
    from spacegame.models.ground_mission import (
        GroundMissionConfig, MissionType, DifficultyTier, GroundMissionRewards,
    )
    return GroundMissionConfig(
        id="test_mission", name="Test", description="test",
...
class TestGroundMissionResultCommodities:
    ...
    def test_default_no_commodities(self) -> None:
        ...
        result = GroundMissionResult(
            config=_make_mission_config(), outcome=MissionOutcome.SUCCESS,
            objectives_completed=1, objectives_total=1,
            turns_taken=10, enemies_defeated=0, enemies_talked=0,
            loot_credits=100, loot_items=[], progress_percent=1.0,
            crew_ids=[], detected=False,
        )
