...
class Player:
    ...
    # A2-20: set of capstone_ids the player has acknowledged. One field, no
    # sub-model (capstones have a single runtime axis: membership in a set).
    # Serializes as a sorted list; deserializes with legacy-safe default of
    # empty set (same tolerance pattern as DilemmaRuntimeState.closed_lenses).
